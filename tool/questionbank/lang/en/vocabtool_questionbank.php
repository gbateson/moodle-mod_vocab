...
$string['fixquestionsresult'] = '{$a->count} log record was fixed {$a->ids}';
$string['fixquestionsresults'] = '{$a->count} log records were fixed {$a->ids}';
...
$string['taskstatus_addingmultimedia'] = 'Adding images, audio and video';
