...
class form extends \mod_vocab\toolform {
    ...
    /** @var int internal value to represent none action */
    const ACTION_NONE = 0;

    /** @var int internal value to represent "fix all" action */
    const ACTION_FIX_ALL = 1;

    /** @var int internal value to represent "fix missing" action */
    const ACTION_FIX_MISSING = 2;

    /** @var int internal value to represent "fix incorrect" action */
    const ACTION_FIX_INCORRECT = 3;

    /** @var int internal value to represent "report all" action */
    const ACTION_REPORT_ALL = 4;

    /** @var int internal value to represent "report missing" action */
    const ACTION_REPORT_MISSING = 5;

    /** @var int internal value to represent "report incorrect" action */
    const ACTION_REPORT_INCORRECT = 6;

    /** @var int internal value to represent "remove all" action */
