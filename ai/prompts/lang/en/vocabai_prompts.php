...
$string['defaultaisettings'] = 'Default AI settings';
$string['defaultquestioncategories'] = 'Default question categories';
$string['defaultquestionsettings'] = 'Default question settings';
$string['defaultquestiontags'] = 'Default question tags';
$string['defaultquestiontypes'] = 'Default question types';
